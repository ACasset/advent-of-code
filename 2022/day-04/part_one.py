...
def check_if_in(first_list, second_list):
    if (first_list[0] in second_list and first_list[len(first_list)-1] in second_list):
        return 1
    
    if (second_list[0] in first_list and second_list[len(second_list)-1] in first_list):
        return 1
